<template>
  <div class="form-container">
    ...
    <form class="form" @submit.prevent="handleSubmit">
      <div class="input-group" v-if="hasName">
      ...
      <div class="input-group" v-if="hasLastName">
      ...
      <div class="input-group">
        ...
        <div class="input-group" v-if="hasRole">
      ...
      <button class="sign" @click="submitForm(userInfo)">
        {{ buttonText }}
      </button>
    </form>
...
import useFormValidation from "@/utils/validations.js";
...
const { errors, validateField, isValid } = useFormValidation(userInfo);
